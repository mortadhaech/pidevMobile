...
public class ListServiceForm extends BaseForm{
    ...
    public ListServiceForm(Resources res ) {
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
         ...
         ListServiceForm a = new ListServiceForm(res);
          a.show();
            refreshTheme();
        });
        ...
        ArrayList<Services>list = ServicesService.getInstance().affichageServices();
    ...
    private void addButton(Image img,Services rec , Resources res) {
        ...
        Label objetTxt = new Label("Date : "+rec.getService_nom(),"NewsTopLine2");
        Label dateTxt = new Label("objet : "+rec.getService_description(),"NewsTopLine2");
        Label etatTxt = new Label("etat : "+rec.getNb_sous_services(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServicesService.getInstance().deleteService(rec.getService_id())) {
                    new ListServiceForm(res).show();
                }
