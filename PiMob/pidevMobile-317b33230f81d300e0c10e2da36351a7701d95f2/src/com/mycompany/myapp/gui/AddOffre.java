...
public class AddOffre extends Form{
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        {
            try {
                Offre t = new Offre(servicee.getText().toString(),sservicee.getText().toString(),adressee.getText().toString(),descriptionn.getText().toString(),imagess.getText().toString());
